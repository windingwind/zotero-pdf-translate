...
| GPT                          | Yes(free-$18)             | _LLM-based_ [OpenAI](https://openai.com/pricing#chat), [AzureGPT](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/reference#chat-completions) or other GPT-like LLM (customGPT)                                                                          |
