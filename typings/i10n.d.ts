...
export type FluentMessageId =
  ...
  | 'service-azuregpt-dialog-thinkingLevel'
  | 'service-baidu'
  | 'service-baidufield'
  | 'service-bing'
  | 'service-bingdict'
  ...
  | 'service-chatgpt-dialog-thinkingLevel'
  | 'service-claude'
  ...
  | 'service-claude-dialog-thinkingLevel'
  | 'service-cnki'
  ...
  | 'service-dialog-help'
  | 'service-dialog-save'
  | 'service-dialog-thinking-default'
  | 'service-dialog-thinking-high'
  | 'service-dialog-thinking-low'
  | 'service-dialog-thinking-medium'
  | 'service-dialog-thinking-off'
  ...
  | 'service-gemini-dialog-thinkingLevel'
  | 'service-google'
  | 'service-googleapi'
  | 'service-gpt-dialog-prompt-hint'
  | 'service-gpt-dialog-prompt-required'
  | 'service-gpt-dialog-thinkingLevel-hint'
  | 'service-gramotadict'
  | 'service-haici'
  | 'service-haicidict'
  | 'service-huoshan'
