...
service-customgpt1=Custom GPT 1🗝️
...
service-deeplcustom-secret-pass=Config
service-deeplcustom-secret-fail=Config
service-deeplcustom-dialog-title=DeepLX(API) Config
service-deeplcustom-dialog-endPoint=EndPoint
service-deeplcustom-dialog-save=Save
service-deeplcustom-dialog-close=Close
service-deeplcustom-dialog-help=Help
...
service-chatgpt-dialog-title={ $service } Config
...
service-nllb-secret-pass=Config
service-nllb-secret-fail=Config
service-nllb-dialog-title=NLLB Config
service-nllb-dialog-model=Model
service-nllb-dialog-serveendpoint=nllb-serve EndPoint
service-nllb-dialog-apiendpoint=nllb-api EndPoint
service-nllb-dialog-apistream=Stream (Only supports nllb-api)
service-nllb-dialog-save=Save
service-nllb-dialog-close=Close