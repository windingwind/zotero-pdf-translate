...
| NLLB                         | No **[Require config]**       | [NLLB Serve](https://github.com/thammegowda/nllb-serve?tab=readme-ov-file#setup) or [nllb-api](https://github.com/winstxnhdw/nllb-api?tab=readme-ov-file#self-hosting)                     |
...
**NLLB**
See [NLLB Serve](https://github.com/thammegowda/nllb-serve?tab=readme-ov-file#setup) or [nllb-api](https://github.com/winstxnhdw/nllb-api?tab=readme-ov-file#self-hosting).
