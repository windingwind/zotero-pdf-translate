...
export type FluentMessageId =
  ...
  | 'pin-window'
  | 'pluginData-addon-mismatch'
  | 'pluginData-backup-failed'
  | 'pluginData-backup-saved'
  | 'pluginData-dialog-title'
  | 'pluginData-export-title'
  | 'pluginData-file-empty'
  | 'pluginData-import-title'
  | 'pluginData-reset-clearTranslations-check'
  | 'pluginData-reset-confirm'
  | 'pluginData-reset-success'
  | 'pluginData-restore-confirm'
  | 'pluginData-restore-failed'
  | 'pluginData-restore-overwrite-check'
  | 'pluginData-restore-success'
  | 'pref-about'
  | 'pref-about-docs'
  | 'pref-about-feedback'
  | 'pref-about-version'
